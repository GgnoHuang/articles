...
On Glows.ai, create an on-demand instance following [this guide](https://docs.glows.ai/docs/create-new). Make sure to select the official pre-configured **GPT OSS 20B** image (img-neqm8dp2).
